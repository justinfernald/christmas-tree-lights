declare module 'christmas-tree' {
  ...
  declare namespace ColorLib {
    export { Color_2 as Color, colors_2 as colors };
  }
  ...
  declare class Vector3_2 {
    ...
    y: number;
    z: number;
    static fromObject(obj: { x: number; y: number; z: number }): Vector3_2;
    ...
    negate(): Vector3_2;
    /** In radians */
    rotateXYZ(angles: { x: number; y: number; z: number }): Vector3_2;
    /** In radians */
